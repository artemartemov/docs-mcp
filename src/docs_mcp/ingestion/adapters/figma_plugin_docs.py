...
class FigmaPluginDocsSource(BaseDocumentationSource):
    ...
    def __init__(self, version: str = "latest"):
        ...
        self.priority_sections = {
            "intro", "getting-started", "quickstart", "basics", "development",
            "api-reference", "plugin-api", "widget-api", "guides", "tutorials",
            "publishing", "community", "examples", "troubleshooting"
        }
        ...
        self.section_categories = {
            "getting_started": ["intro", "getting-started", "quickstart", "prerequisites"],
    ...
    async def _discover_from_page(self, url: str, discovered_urls: set, max_depth: int = 3) -> None:
                ...
                for selector in nav_selectors:
                    ...
                    for link in links:
                        ...
                        if href:
                            ...
                            if self._is_plugin_docs_url(full_url) and full_url not in discovered_urls:
                                if max_depth > 1:
                                    await self._discover_from_page(full_url, discovered_urls, max_depth - 1)
                                else:
    ...
    def _is_plugin_docs_url(self, url: str) -> bool:
        ...
        parsed = urlparse(url)
        return (
            parsed.netloc == "www.figma.com" and
            "/plugin-docs" in parsed.path and
    ...
    def _determine_doc_type(self, url: str, title: str, content: str) -> str:
        ...
        if any(term in url_lower for term in ['api-reference', 'reference']):
        ...
        elif any(term in url_lower for term in ['tutorial', 'quickstart', 'getting-started']):
            return "tutorial"
            ...
            return "introduction"
        elif any(term in content_lower for term in ['function', 'method', 'property', 'interface']):
    ...
    def _generate_tags(self, url: str, title: str, content: str) -> List[str]:
        ...
        if any(term in title_lower for term in ["introduction", "getting started", "quickstart"]):
            tags.append("beginner")
        elif any(term in title_lower for term in ["advanced", "complex", "optimization"]):
