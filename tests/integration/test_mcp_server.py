...
class TestMCPServerIntegration:
    ...
    async def test_error_handling(self):
        ...
        for query, category, limit in edge_cases:
            ...
            assert isinstance(result, str), f"Should handle edge case gracefully: {query}, {category}, {limit}"
...
async def test_configuration_validation():
    ...
    assert settings.environment in ['development', 'production'], "Environment should be valid"
