    ...
    def test_css_properties_content(self):
        ...
        try:
            ...
            if properties_results['documents'] and len(properties_results['documents'][0]) > 0:
                ...
                key_terms = ["property", "value", "syntax", "display", "position", "width", "height"]
                ...
                self.log_test_result("CSS Properties Content", False, "No CSS properties docs found")
        except Exception as e:
    ...
    def test_css_selectors_content(self):
        ...
        try:
            ...
            if selectors_results['documents'] and len(selectors_results['documents'][0]) > 0:
                ...
                selector_terms = ["selector", "class", "element", "pseudo", "attribute", "universal"]
    ...
    def test_css_layout_content(self):
        ...
        try:
            ...
            if layout_results['documents'] and len(layout_results['documents'][0]) > 0:
                ...
                layout_terms = ["flexbox", "grid", "layout", "position", "float", "flex", "inline"]
    ...
    def test_css_animations_content(self):
        ...
        try:
            ...
            if animation_results['documents'] and len(animation_results['documents'][0]) > 0:
                ...
                animation_terms = ["animation", "transition", "keyframes", "transform", "duration"]
                ...
                self.log_test_result("CSS Animations Content", False, "No CSS animations docs found")
        except Exception as e:
    ...
    def test_css_responsive_content(self):
        ...
        try:
            ...
            if responsive_results['documents'] and len(responsive_results['documents'][0]) > 0:
                ...
                responsive_terms = ["responsive", "media", "query", "breakpoint", "viewport", "mobile"]
                ...
                self.log_test_result("CSS Responsive Content", False, "No responsive design docs found")
        except Exception as e:
    ...
    def test_doc_type_distribution(self):
        ...
        try:
            ...
            if css_docs['metadatas']:
                ...
                expected_types = ["css_reference", "guide", "tutorial", "reference", "css_documentation"]
                found_expected = [dt for dt in expected_types if dt in doc_types]
                
                if len(found_expected) >= 2:
                    type_summary = ", ".join([f"{dt}: {doc_types[dt]}" for dt in found_expected[:3]])
                    self.log_test_result(
